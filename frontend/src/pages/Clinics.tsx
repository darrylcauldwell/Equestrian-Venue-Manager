    ...
    <div className="clinics-page">
      ...
      <div className="tabs-container">
        ...
        {isCoach ? (
          <>
            <button
              className={`tab ${activeTab === 'my-clinics' ? 'active' : ''}`}
          ...
          <>
            ...
            {user && (
              <button
                className={`tab ${activeTab === 'my-registrations' ? 'active' : ''}`}
